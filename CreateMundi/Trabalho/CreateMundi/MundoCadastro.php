...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-C6RzsynM9kWDrMNeT87bh95OGNyZPhcTNXj1NW7RuBCsyN/o0jlpcV8Qyq46cDfL" crossorigin="anonymous"></script>
    ...
    <div class="container">
        <h1 style="text-align: center;">Criar Mundo</h1>
        <div class="dropdown">
    ...
    <a class="dropdown-item" href="#">Facções</a>
    <a class="dropdown-item" href="#">Personagens</a>
    </div>
    
    <form id="loginForm" method="POST" action="controller/MundoController.php?action=<?php if($_REQUEST["action"]== "cadastro"){
            echo 'cadastrar"';
        }else{
                echo 'edit"';
            }
        ?>>
                <input type="text" style="background-color:#a6a6a6" class="form-control-sm mx-auto d-flex justify-content-center"
                    id="nomeMundo" name="nome" placeholder="Nome do mundo" value=<?php if($_REQUEST["action"] == "cadastro"){
                        echo "";
                    }else{
                        echo $_REQUEST["nome"];
                    } ?>>
            ...
            <div class="mb-3">
                <textarea type="text" style="background-color:#a6a6a6" class="form-control-sm mx-auto d-flex justify-content-center"
                    id="descricaoMundo" name="descricao" placeholder="Descrição do mundo"><?php if($_REQUEST["action"] == "cadastro"){
                        echo "";
                    }else{
