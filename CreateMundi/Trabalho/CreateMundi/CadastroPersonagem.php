...
<head>
    <title>CadastroPersonagem</title>
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-C6RzsynM9kWDrMNeT87bh95OGNyZPhcTNXj1NW7RuBCsyN/o0jlpcV8Qyq46cDfL" crossorigin="anonymous"></script>
    ...
    <div class="container">
        <h1 style="text-align: center;">Criar Personagem</h1>
        <div class="dropdown">
    ...
    <a class="dropdown-item" href="#">Personagens</a>
        ...
        <form id="loginForm" method="POST" action="controller/PersonagemController.php?action=<?php if($_REQUEST["action"]== "cadastro"){
                echo 'cadastrar"';
            }else{
                echo 'edit"';
            }
                ...
                <input type="text" style="background-color:#a6a6a6" class="form-control-sm mx-auto d-flex justify-content-center"
                    id="nomeFaccao" name="nome" placeholder="Nome do Personagem" value=<?php if($_REQUEST["action"]== "cadastro"){
                        echo "";
                    }else{
                        echo $_REQUEST["nome"];
                    } ?>>
            ...
            <div class="mb-3">
                <textarea type="text" style="background-color:#a6a6a6" class="form-control-sm mx-auto d-flex justify-content-center"
                    id="descricaoFaccao" name="descricao" placeholder="Descrição do Personagem"><?php if($_REQUEST["action"] == "cadastro"){
                        echo "";
                    }else{
            ...
            <div = class="mb-3">
            	<label class="form-control-sm mx-auto d-flex justify-content-center">Qual facão quer afiliar ele</label>
            ...
            <div class="botoes">
               <button type="submit" onclick="" class="btn btn-primary d-flex justify-content-center align-items-center mx-1">Salvar</button>
            </div>
